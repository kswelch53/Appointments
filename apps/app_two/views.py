...
from ..app_two.models import Task
import datetime
...
def add_task(request):
    print("This is add_task method in app2 views.py")
# added
    time_now = datetime.datetime.now()
    # get form data
...
# error message; redirect
                ...
                # checks whether session user has any Task objects
                # if user's task count is 0, creates object, if count > 0, checks through objects in for-loop
                ...
                task_count = user_tasks.count() # counts how many Task objects are linked to session user
                if task_count == 0:
...
# error message; redirect
                        ...
                        return redirect('app2:add_task')# stays on form page
...
def edit(request, task_id):
    print("This is edit method in app2 views.py")
...
# redirect
            ...
            return redirect('app2:edit', task_id)
    ...
    return render(request, 'app_two/update.html', context)


def delete(request, task_id):
    print("This is delete method in app2 views.py")
